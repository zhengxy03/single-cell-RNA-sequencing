...
T_cell_ids <- colnames(T_expr_matrix)
sampled_T_cell_ids <- sample(T_cell_ids, size = 1000)  # 抽取1000个T细胞
T_expr_matrix <- T_expr_matrix[, sampled_T_cell_ids]   # 更新T细胞表达矩阵
# ====================================

T_matrix <- T_expr_matrix  # 抽样后的 T 细胞
